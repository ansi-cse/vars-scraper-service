...
public abstract class BDSDetailTemplate<T> extends BDSSupportScraper {
    ...
    public abstract T getTypeOfRealEstate(Elements elements, T post, String postType);
    public abstract T getExtraInformation(Elements elements, T post, String postType);
